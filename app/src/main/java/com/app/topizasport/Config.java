...
public class Config {
     ...
     * URL / LIST OF URLS
     */
    public static final String[] TITLES = new String[]{"All Sports", "News", "Previews", "Highlights", "Livescore"};
    public static final String[] URLS = new String[]{"https://www.liveonscore.com/category/all-sports/",
            "https://www.liveonscore.com/category/news/", "https://www.liveonscore.com/category/all-sports/soccer/preview-and-predictions/", "https://www.liveonscore.com/category/all-sports/soccer/highlight-videos/", "https://www.liveonscore.com/livescore"};
    ...
    public static String ANALYTICS_ID = "YOUR-ANALYTICS-ID";
    ...
    //All urls that should always be opened outside the WebView and in the BrowserActivity, download manager, or their respective app
